...
import { Button, Heading, Text, Background, Column, Row, SmartLink } from "@once-ui-system/core";
  ...
  return (
    ...
    >
      ...
      <Column maxWidth="s" horizontal="center" gap="m">
        ...
        <Row gap="16" marginTop="m" wrap horizontal="center" vertical="center" s={{ direction: "column" }}>
          {newsletter.calLink && (
            <Button
              href={newsletter.calLink}
              size="m"
              variant="primary"
              prefixIcon="calendar"
            >
          ...
          {newsletter.email && (
            <Text variant="body-default-m" onBackground="neutral-weak">
              or email me at{" "}
              <SmartLink href={`mailto:${newsletter.email}`}>
                {newsletter.email}
              </SmartLink>
            </Text>
          )}
